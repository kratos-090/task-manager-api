...
Evirnment variable to create:<br/>
  &nbsp&nbspPORT=port no,for local you can add any port no., for deployment get it from envirnment<br/>
  &nbsp&nbspSENDGRID_API_KEY->send grid api key<br/>
  &nbsp&nbspJWT_SECRET->you can give anything,used for hashing passwords<br/>
  &nbsp&nbspMONGOGB_URL->you database url<br/>
Steps:<br/>
